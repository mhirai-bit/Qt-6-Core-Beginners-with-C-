...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Animal_t, stringdata0) + ofs), len 
...
const QMetaObject Animal::staticMetaObject = { {
    ...
    qt_meta_stringdata_Animal.offsetsAndSize,
    qt_meta_data_Animal,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Animal_t
