...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Canine_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Canine_t qt_meta_stringdata_Canine = {
    {
QT_MOC_LITERAL(0, 6) // "Canine"
...
const QMetaObject Canine::staticMetaObject = { {
    QMetaObject::SuperData::link<Mammal::staticMetaObject>(),
    qt_meta_stringdata_Canine.offsetsAndSize,
    qt_meta_data_Canine,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Canine_t
