...
#include <memory>
#include "../../../qt6cb-8-5/applicance.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Applicance_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Applicance_t qt_meta_stringdata_Applicance = {
    {
QT_MOC_LITERAL(0, 10) // "Applicance"
...
const QMetaObject Applicance::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Applicance.offsetsAndSize,
    qt_meta_data_Applicance,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Applicance_t
, QtPrivate::TypeAndForceComplete<Applicance, std::true_type>
