...
QT_MOC_LITERAL(4, 4), // "bark"
QT_MOC_LITERAL(9, 0), // ""
QT_MOC_LITERAL(10, 5) // "chase"
...
void Dog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->bark(); break;
        case 1: _t->chase(); break;
        default: ;
        }
        ...
        {
            using _t = void (Dog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Dog::bark)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Dog, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
