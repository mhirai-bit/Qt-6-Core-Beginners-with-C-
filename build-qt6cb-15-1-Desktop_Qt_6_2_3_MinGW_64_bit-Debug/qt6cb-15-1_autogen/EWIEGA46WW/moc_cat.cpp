...
void Cat::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Cat::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cat::run)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Cat, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
